...
public class consulta extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(52, 52, 52)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(credito, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        ...
        x.setCodigo(Integer.parseInt(codigo.getText()));
        
        boolean j = c.busca(x);
        if (j) {
        nome.setText(x.getNome());
        credito.setText(String.valueOf(x.getCredito()));
        JOptionPane.showMessageDialog(null, "Cliente encontrado com sucesso!");
        }
        else {
            JOptionPane.showMessageDialog(null, "Nao conseguimos buscar cliente");
        ...
        Cliente x = new Cliente();
          ...
          if (j) {
            JOptionPane.showMessageDialog(null, "O cliente foi deletado com sucesso");
              ...
              JOptionPane.showMessageDialog(null, "O cliente nao pode ser deletado");
          }
